  ...
  return (
    <div className="min-h-screen">
      ...
      <div className={`transition-all duration-500 ease-in-out z-40 ${
        isSticky 
          ? 'fixed top-0 left-0 right-0 bg-white/95 backdrop-blur-lg shadow-md border-b border-primary-100' 
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="relative py-2">
            ...
            {canScrollLeft && (
              <button
                onClick={() => scroll('left')}
                className="absolute left-0 top-1/2 -translate-y-1/2 z-10 bg-white shadow-md hover:shadow-lg border border-gray-200 rounded-full p-2 transition-all duration-300 hover:scale-110 hover:bg-primary-50"
              >
              ...
              <button
                ...
                className={`flex-shrink-0 flex flex-col items-center gap-2.5 p-2.5 rounded-xl transition-all duration-300 group ${
                  selectedCategory === 'all'
                    ? 'bg-gradient-to-br from-primary-500 to-primary-600 text-white shadow-lg scale-105 ring-2 ring-primary-200'
            ...
            {canScrollRight && (
              <button
                ...
                className="absolute right-0 top-0 -translate-y-1/2 z-10 bg-white shadow-md hover:shadow-lg border border-gray-200 rounded-full p-2 transition-all duration-300 hover:scale-110 hover:bg-primary-50"
              >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8 text-center">
          <div className="inline-flex items-center gap-3 bg-white rounded-full px-6 py-3 shadow-md border border-primary-100">
