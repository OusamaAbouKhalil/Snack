...
const translations: Record<string, Record<Language, string>> = {
  ...
  'guest.joinEarnPoints': { en: 'Join Mat3amji to earn points on your next order', ar: 'انضم إلى Mat3amji لتربح نقاطاً على طلبك القادم' },
  ...
  'guest.joinMat3amji': { en: 'Join Mat3amji', ar: 'انضم إلى Mat3amji' },
  'guest.signupPerk': {
  ...
  'guest.whyJoin': { en: 'Why join Mat3amji?', ar: 'لماذا تنضم إلى Mat3amji؟' },
